...
namespace Vectors {
  ...
  */
  ...
  public:
    ...
    /// Diadic product.
    friend const ThreeTensor diad(const ThreeVector&, const ThreeVector&);
    /// Equality check.
  ...
  */
  ...
  public:
    ...
    static FourTensor createUpDown(double,double,double,double,double,double,double,double,
                                   double,double,double,double,double,double,double,double);
    ...
    const FourVector operator () (uint) const;
    /// Positive sign.
